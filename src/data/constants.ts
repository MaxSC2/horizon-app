...
export const STYLE_LIST = [
  { 
    ...
    radius: 12, shadow: 10, borderWidth: 1, headerBold: false, 
  ...
  { 
    ...
    accent: "bar", showGlow: true, showXP: true 
  },
  { 
    id: "minimal", name: "Минимал", icon: "▢", 
    desc: "Плоский, только текст и линии",
    radius: 4, shadow: 0, borderWidth: 1, headerBold: false, 
    accent: "none", showGlow: false 
  },
  { 
    id: "glass", name: "Glass", icon: "◈", 
    desc: "Матовое стекло, полупрозрачность",
    radius: 20, shadow: 6, borderWidth: 1, headerBold: false, 
    accent: "glow", showGlow: true, opacity: 0.7 
  },
  { 
    id: "cyber", name: "Cyber", icon: "⬡", 
    desc: "Неоновый, технологичный",
    radius: 6, shadow: 15, borderWidth: 2, headerBold: true, 
    accent: "neon", showGlow: true, glowColor: "#0ff" 
  },
  { 
    id: "retro", name: "Ретро", icon: "■", 
    desc: "Пиксельный, 8-bit стиль",
    radius: 0, shadow: 8, borderWidth: 3, headerBold: true, 
    accent: "pixel", showGlow: false 
  },
  { 
    id: "rounded", name: "Soft", icon: "○", 
    desc: "Мягкие формы, всё скруглено",
    radius: 24, shadow: 4, borderWidth: 1, headerBold: false, 
    accent: "line", showGlow: false 
  },
];
